// Set de iconos SVG inline (sin dependencias externas), tomados del diseño en Figma.
...
export function BluetoothIcon({ size = 18, color = 'currentColor' }: { size?: number; color?: string }) {
  return (
...
export function BlockchainIcon({ size = 18 }: { size?: number }) {
  return (
...
export function FileIcon({ size = 40 }: { size?: number }) {
  return (
